...
4. **Macro replay อ้าง visual anchor.** เริ่มนับ macro t=0 ตอน detect หน้า GAMEPLAY (ปุ่ม pause) ทั้งตอน record และ replay — หักล้าง loading time ห้ามใช้ fixed delay เป็นหลัก
